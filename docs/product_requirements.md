...
2. the backend provides all kinds of data API such as run a SQL and return a small subset of output immediately, or submit a SQL to a Spark cluster and materialize the output as a parquet file etc.
